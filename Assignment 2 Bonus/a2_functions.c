...
// function prints new menu, using username for personalization
void print_menu_2(char *username)
{
   printf("\n\n***********************************************\n\tWelcome %s\t\n***********************************************\n\n", username);
   printf("\n1. Manage a user's profile (change password)\n2. Manage a user's posts (add/remove)\n3. Manage a user's friends (add/remove)\n4. Display a friend's posts\n5. Exit\n");
}
